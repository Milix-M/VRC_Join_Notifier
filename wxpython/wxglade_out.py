...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Fri Jul 15 04:01:39 2022
#
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, u"自動起動設定", "")
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(wx.ID_ANY, u"終了", "")
        self.frame_menubar.Append(wxglade_tmp_menu, u"通知除外設定")
        wxglade_tmp_menu = wx.Menu()
        wxglade_tmp_menu.Append(wx.ID_ANY, u"バージョン情報", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, "Booth", "")
        wxglade_tmp_menu.Append(wx.ID_ANY, u"作者Twitter", "")
